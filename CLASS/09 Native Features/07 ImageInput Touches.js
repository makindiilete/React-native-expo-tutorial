/*
 Now we want to handle the touch event of our image input field... We make it touchable by wrapping the component inside a Touchable component (TouchableWithoutFeedback bcos once touched, we open the gallery so we need no extra visual feedback)
*/
...
export default function App() {
  ...
  return (
    <AppScreen>
      <AppImageInput imageUri={imageUri} onChangeImage={onChangeImage} />
    </AppScreen>
  );
}
